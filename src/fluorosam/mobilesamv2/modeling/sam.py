...
from .travel_mask_decoder import TravelMaskDecoder
...
class Sam(nn.Module):
    ...
    def forward(
        ...
        raise NotImplementedError("Does not work with text prompts yet.")
        ...
        for image_record, curr_embedding in zip(batched_input, image_embeddings):
            ...
            low_res_masks, _, iou_predictions = self.mask_decoder(
